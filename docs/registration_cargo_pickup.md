# Оформление забора
"Заявка на забор" оформляется для забора груза у вас/ вашего поставщика и не п
...
## Прикрепленные файлы
Обязательно прикрепите Акт приема-передачи посылок, который можно выгрузить из личного кабинета FulЕx в разделе “Отслеживание”, добавьте иные дополнительные документы.
