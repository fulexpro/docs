...
- Для заказов AliExpress: FBS_AL _<номер заказа из кабинета маркетплейса>_. Пример: FBS_ALA00568978956
- Для заказов СБЕРМЕГАМАРКЕТ: FBS_S _<номер заказа из кабинета маркетплейса>_. Пример: FBS_S2596379655
